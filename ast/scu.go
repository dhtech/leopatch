...
func (a *Ast) ResetCpu() {
	...
	a.MustWrite32(WDT1_RLD_CTR, 16)
	a.MustWrite32(WDT1_RESTART, WDT_RESTART_PASSWORD)
	// 0x2 - Reset system after timeout
	// 0x1 - WDT enable
	a.MustWrite32(WDT1_CTRL, 0x3)
}
